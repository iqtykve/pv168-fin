...
public class Account {
    ...
    public Account(String birthName, String givenName, BigDecimal sumAmount, String accountNumber) {
    ...
    public String toString() {
        return "Account{id=" + id + ", birth name=" + birthName + ", given name=" + givenName + ", sum amount=" + sumAmount + ", account number='" + accountNumber + "}";
    }
