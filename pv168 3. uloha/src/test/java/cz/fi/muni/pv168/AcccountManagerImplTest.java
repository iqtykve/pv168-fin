...
import cz.fi.muni.pv168.AccountException;
...
public class AcccountManagerImplTest {
    ...
    public void createAccount() throws AccountException{
        ...
        assertEquals("Franta",acc.getBirthName());
        assertEquals("Vizl",acc.getGivenName());
        assertEquals(new BigDecimal("100"),acc.getSumAmount());
        assertEquals("800/0100",acc.getAccountNumber());
    ...
    public void findAllAccount() {
        assertTrue(manager.findAllAccount().isEmpty());
        ...
        List<Account> result =  manager.findAllAccount();
